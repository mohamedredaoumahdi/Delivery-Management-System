...
class AuthController {
    generateTokens(userId, role) {
        const accessToken = jsonwebtoken_1.default.sign({ userId, role }, config_1.config.jwtSecret, { expiresIn: config_1.config.jwtExpiresIn });
        const refreshToken = jsonwebtoken_1.default.sign({ userId, role, tokenId: (0, uuid_1.v4)() }, config_1.config.jwtRefreshSecret, { expiresIn: config_1.config.jwtRefreshExpiresIn });
